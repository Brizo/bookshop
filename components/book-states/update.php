<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $_SESSION['description'] = $bookState['description'];
				...
				<div class="col-sm-8">
					<form class="form-horizontal" role="form" action="components/book-states/controller.php" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea rows="3" cols="50" class="form-control" placeholder="Enter book state descripion" name="description"><?php  if (isset($_SESSION['description'])) {echo $_SESSION['description'];} ?></textarea>
							</div>
						</div>                      
