				...
				<div class="col-sm-8">
					<form class="form-horizontal" role="form" action="components/subject-books/controller.php" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">                                
								<select class="form-control" id="book" name="subjectBook">
						...
						<div class="form-group">
							<div class="col-sm-8 col-sm-offset-4">
								...
								<a href="/bookshop?action=subject-books" class="btn btn-warning"><span class="glyphicon glyphicon-remove-circle"></span>&nbsp;Cancel</a>
							</div>
						</div>                
					</form>
				</div>
